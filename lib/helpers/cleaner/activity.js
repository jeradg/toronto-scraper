module.exports = function( rawActivity, rawAge ) {
  ...
  // Fix transposition of activity and type
  if ( type && activity.match( /Widths|Adult|All Ages|Arthritis|Deep|Female|Older Adult|Shallow|Preschool|Youth/ ) ) {
